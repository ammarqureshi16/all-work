...
var studentsscore=["Score of Micheal is "+300, "Score of John is "+350, "Score of JohnySins is "+450 ]
var percentage_of_micheal=300*100/500
var percentage_of_john=350*100/500
var percentage_of_johnysins=450*100/500
var micheal_score_and_percentage=["Score of Micheal is ",300,"."+"Percentage :",percentage_of_micheal,"%",]
console.log(micheal_score_and_percentage)
var john_score_and_percentage=["Score of John is ",350,"."+"Percentage :",percentage_of_john,"%"]
console.log(john_score_and_percentage)
var johnysins_score_and_percentage=["Score of JohnySins is ",450,"."+"Percentage :",percentage_of_johnysins,"%"]
...
console.log(color)
//Question 12. Part(F)
var userInput3=prompt("Add A Color & Color Name. Then Add The Color To Desired Position/Index.")
...
var arr=["Web"+" "+"&"+" "+"Mobile"+" "+"App"+"Development"+"Course"]
console.log(arr)
...
var array=[
    ["Hello Jee"], [1, 2, 3, 4, 5, 6, 7, 8], [true, false]
]
console.log(array)
// Question: 21.
